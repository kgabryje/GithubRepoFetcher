...
class SearchMenu extends Component {
    ...
    render() {
        return (
            <form>
                <FormControl>
                    <Input placeholder='Repo name...' onChange={event => this.userInputHandler(event.target.value)}/>
                </FormControl>
                <FormControl>
                    <Select value={this.props.selectValue} onChange={event => this.props.onSelectChange(event.target.value)}>
